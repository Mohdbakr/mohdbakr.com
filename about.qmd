...
::: {.grid}
::: {.g-col-12 .g-col-md-6}
The [Berkeley MIDS](https://ischoolonline.berkeley.edu/data-science/curriculum/){target="_blank"} from the [School of Information](https://www.ischool.berkeley.edu/){target="_blank"} formalized that practice: statistics, ML, data engineering, and causal inference assembled into a coherent technical foundation.
